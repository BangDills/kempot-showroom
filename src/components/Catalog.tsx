...
export default function Catalog({ cars }: { cars: Car[] }) {
  ...
  const inputCls =
    "rounded-[10px] border border-line bg-white px-3 py-2.5 text-sm outline-none focus:border-orange-brand";
  ...
  return (
    <div className="mt-6">
      <div className="mb-6 flex flex-wrap items-center gap-2.5">
        ...
        <select value={price} onChange={(e) => setPrice(e.target.value)} className={inputCls}>
      ...
      {list.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-line bg-white px-6 py-16 text-center text-[15px] text-muted">
